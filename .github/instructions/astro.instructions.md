...
- Define and document every component `Props` interface in frontmatter so the
  component contract is self-explanatory.
- Comments should explain intent or an accessibility/design decision, not
  paraphrase the markup or script below them.
